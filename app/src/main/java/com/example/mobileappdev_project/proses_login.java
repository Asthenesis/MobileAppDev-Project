...
public class proses_login extends AsyncTask<String,Void, String> {
    ...
    private String url_proses_login = "https://lockyourticket.000webhostapp.com/Login.php"; // link proses login di php
    ...
    public proses_login(LoginActivity2 loginActivity2) {

    }

    public void proses_crud(Context context) {
